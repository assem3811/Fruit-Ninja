...
public class Level1BestScore {
    ...
    public void writeToFile(int bestscore) {
        ...
        try {
            ...
            FileWriter fr = new FileWriter("E:\\Fruit Ninja Game  Project 2\\src\\Controller\\High Scores\\highScoresLevel1.txt", true);
    ...
    public ArrayList<Integer> ReadFromFile()
    {
        ...
        try {
            scanner = new Scanner(new File("E:\\Fruit Ninja Game  Project 2\\src\\Controller\\High Scores\\highScoresLevel1.txt"));
